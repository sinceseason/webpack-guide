    ...
    var easyDialog = function () {
        ...
        Dialog.prototype = {
            ...
            createDialogWrap: function (tmpl) {
                ...
                var header = '<div class="modal-title clearfix"><span class="head-title-left">' + tmpl.header + '</span><span class="head-close title-close JS-right-close"></span></div>';
                var content = '<div class="modal-content"><div class="modal-tips">' + tmpl.content + ' </div></div>'
                var footer = '<div class="modal-operate"><button class="btn-full btn-red JS-dialog-close">' + tmpl.btn + '</button></div>';
                var dialogTmpl = [
                        '<div id="JS-tipDialog" class="modal-wrap modal-size-normal">',
                        header,
                        content,
                        footer,
                        '</div>'
        ...
        var extend = {
            open: function () {
                ...
                if (typeof (options.container) === 'string') {
                    window.$('#' + options.container).find('input').val('');
                }
                ...
                if (options.overlay) {
                    ...
                    event.unbind(overlay, 'click');
                    event.bind(overlay, 'click', options.overlayClick);
                }
                ...
                // 自定义业务添加的功能按钮
                var $rightCloseButton = window.$('.JS-right-close,.title-close');
                var $submitCloseButton = window.$('.JS-dialog-close');
                // 绑定确定按钮的回调函数
                if (dialogYesBtn) {
                ...
                // 关闭弹框
                $rightCloseButton.bind('click', function () {
                    self.close();
                })
                $submitCloseButton.bind('click', function () {
                    if (options.reload) {
                ...
                Dialog.data('dialogElements', {
                    ...
                    $submitCloseButton: $submitCloseButton
                });
            },
            ...
            close: function () {
                ...
                // doc.getElementById(options.container.id)
                // 隐藏弹出层
                ...
                // 自定义解绑
                if (elements.$rightCloseButton) {
                    elements.$rightCloseButton.unbind('click');
                }
                if (elements.$submitCloseButton) {
                    elements.$submitCloseButton.unbind('click');
                }
