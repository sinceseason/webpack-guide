module.exports = {
    ...
    amount: /^([\d]+|([\d]+[.]?[\d]{1,2}))$/,
    contentNum: /^[\S\s]{10,500}$/,
    oldPwd: /^(?![^a-zA-Z]+$)(?!\D+$)[a-zA-Z\d]{6,16}$/,
    realName: /^([\u4E00-\uFA29]|[\uE7C7-\uE7F3]|[a-zA-Z0-9])*$/,
    ip: /(\d|[1-9]\d|1\d{2}|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d{2}|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d{2}|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d{2}|2[0-4]\d|25[0-5])|(:[0-9]+)/
};